...
const InvoicesPage = (props) => {
    ...
    const filterredInvoices = invoices.filter(i => 
    ...
    const paginatedInvoices = Pagination.getData(filterredInvoices,currentPage,itemsPerPage)
    ...
    return ( 
        <>
            ...
            {itemsPerPage < filterredInvoices.length && <Pagination 
